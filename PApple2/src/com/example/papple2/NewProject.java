...
public class NewProject extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(items.size() == 0)
		{
			...
			ItemPart item4 = new ItemPart("Cover", getResources().getDrawable(R.drawable.shell), getResources().getColor(color.rood), getResources().getDrawable(R.drawable.coverd));
			ItemPart item5 = new ItemPart("Shell", getResources().getDrawable(R.drawable.ic_launcher), getResources().getColor(color.paars), getResources().getDrawable(R.drawable.shelld));
			ItemPart item6 = new ItemPart("Screen", getResources().getDrawable(R.drawable.ic_launcher), getResources().getColor(color.grijs), getResources().getDrawable(R.drawable.screend));
			ItemPart item7 = new ItemPart("Side", getResources().getDrawable(R.drawable.ic_launcher), getResources().getColor(color.blauw), getResources().getDrawable(R.drawable.sided));
